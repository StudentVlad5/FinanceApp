...
const AccountDetails = () => {
  ...
  console.log('reestrById', reestrById);
  return (
    <div>
      <Typography variant='h5'>Деталі рахунку {id}</Typography>
      <ReestrTable data={reestrById} onSave={handleSave} onDelete={handleDelete} />
    </div>
  );
};
