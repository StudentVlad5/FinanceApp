"use strict";(self.webpackChunkAddax_CRM=self.webpackChunkAddax_CRM||[]).push([[905],{518:(e,t,i)=>{i.d(t,{MG:()=>c,NW:()=>m,aV:()=>p,ah:()=>w,c$:()=>x,vX:()=>f,w4:()=>h,yt:()=>d});var o=i(8258),n=i(7291),r=i(1529),a=i(1384),s=i(5475),l=i(4586);const d=(0,r.Ay)(o.S1)`
  width: 100%;
  text-align: start;
`,p=r.Ay.div`
  position: absolute;
...
`)},3905:(e,t,i)=>{i.r(t),i.d(t,{default:()=>g});var o=i(5043),n=i(8617),r=i(3216),a=i(3003),s=i(3892),l=i(9388),d=i(1314),p=i(4586),c=i(7291),h=i(518),m=i(8258),w=i(1384),f=i(579);const x=()=>{const[e,t]=(0,o.useState)(!1),i=(0,a.wA)(),n=(0,r.Zp)(),x=(0,s.Wx)({initialValues:{email:""},validationSchema:d.A.changePasswordSchema,onSubmit:async e=>{try{t(!0),i((0,l.h)({email:e.email})),n("/login")}catch(o){console.error("Forgot password error:",o)}finally{t(!1)}}}),g=!!x.errors.email||!x.values.email||!x.touched.email;return(0,f.jsx)(p.wn,{children:(0,f.jsx)(p.mc,{children:(0,f.jsxs)(h.c$,{onSubmit:x.handleSubmit,autoComplete:"off",children:[(0,f.jsx)(h.yt,{children:"Forgot Password"}),(0,f.jsxs)(m.zB,{children:[(0,f.jsxs)(m.lR,{htmlFor:"email",children:[(0,f.jsx)("span",{children:"E-mail"}),x.errors.email&&x.touched.email&&(0,f.jsx)(m.$D,{children:x.errors.email})]}),(0,f.jsx)(h.w4,{style:{borderColor:(b=x.values.email,u=x.errors.email,b?u?c.w.colors.red:c.w.colors.darkGreen:null)},name:"email",type:"email",value:x.values.email,onChange:x.handleChange,onBlur:x.handleBlur}),x.errors.email&&x.touched.email&&(0,f.jsx)(h.aV,{style:{bottom:"22px"},children:x.errors.email})]}),(0,f.jsx)(w.rt,{type:"submit",disabled:g||e,"aria-label":"submit to change password",children:e?"Loading...":"Change"}),(0,f.jsxs)(h.vX,{children:[(0,f.jsx)("span",{children:"Already have an account?"}),(0,f.jsx)(h.ah,{to:"/login",children:"Log In"})]})]})})});var b,u},g=()=>((0,o.useEffect)((()=>{window.scrollTo({top:0,left:0,behavior:"smooth"})}),[]),(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(n.k,{title:"Forgot Password",description:""}),(0,f.jsx)(x,{})]}))},1314:(e,t,i)=>{i.d(t,{A:()=>n});var o=i(899);const n={registerSchema:o.Ik().shape({name:o.Yj().required("Require field"),email:o.Yj().email("Invalid email").required("Require field"),phone:o.ai().nullable(!0).required("Require field"),password:o.Yj().min(4,"Password too short (min 4)").max(32,"Password too long (max 32)").matches(/^\s*\S+\s*$/,"Password must be without spaces").required("Require")}),schemasLogin:o.Ik().shape({email:o.Yj().email("Invalid email").required("Require"),password:o.Yj().min(4,"Password too short (min 4)").max(32,"Password too long (max 32)").matches(/^\s*\S+\s*$/,"Password must be without spaces").required("Require")}),changePasswordSchema:o.Ik().shape({email:o.Yj().email("Invalid email").required("Require field"),password:o.Yj().min(4,"Password too short (min 4)").max(32,"Password too long (max 32)").matches(/^\s*\S+\s*$/,"Password must be without spaces").required("Require")}),updateUserSchema:o.Ik().shape({name:o.Yj().required("Require field"),surname:o.Yj(),email:o.Yj().email("Invalid email").required("Require field"),phone:o.ai(),avatar:o.Yj(),favorites:o.YO(),events:o.YO(),role:o.Yj()}),createUserSchema:o.Ik().shape({name:o.Yj().required("Require field"),surname:o.Yj(),email:o.Yj().email("Invalid email").required("Require field"),password:o.Yj(),phone:o.ai(),avatar:o.Yj(),favorites:o.YO(),events:o.YO(),role:o.Yj()}),updatePasswordSchema:o.Ik().shape({password:o.Yj(),confirmPassword:o.Yj()})}}}]);
//# sourceMappingURL=905.3c084f5c.chunk.js.map